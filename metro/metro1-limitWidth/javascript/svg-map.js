...
//              $('#station-box-arrow').css('background', 'url(images/arrow_right.png) no-repeat');
                $('#station-box-arrow').removeClass("arrow_left arrow_up arrow_down").addClass("arrow_right");
...
//              $('#station-box-arrow').css('background', 'url(images/arrow_left.png) no-repeat');
                $('#station-box-arrow').removeClass("arrow_right arrow_up arrow_down").addClass("arrow_left")
            } else if (y < m) {
                //向下显示弹出框
                arrow_x = x - arrow_w / 2;
...
//              $('#station-box-arrow').css('background', 'url(images/arrow_down.png) no-repeat');
                $('#station-box-arrow').removeClass("arrow_left arrow_up arrow_right").addClass("arrow_down");
            } else {
                arrow_x = x - arrow_w / 2;
                box_x = x - box_w / 2 - space_w;
                arrow_y = y - arrow_w;
...
//              $('#station-box-arrow').css('background', 'url(images/arrow_up.png) no-repeat');
                $('#station-box-arrow').removeClass("arrow_left arrow_right arrow_down").addClass("arrow_up");
            }
...
//		this.height = document.documentElement.clientHeight - 5;
        this.width = document.getElementById("map").offsetWidth-5;
        this.height = document.getElementById("map").offsetHeight-5;
        this.svg.setAttribute("width", this.width);
        this.svg.setAttribute("height", this.height);
        $('#map-controls .slider').css('left', svgMap.width - 79);
        $('#move-controls').css('left', svgMap.width - 106);
        $('#zoom-in').css('left', svgMap.width - 80);
        $('#zoom-out').css('left', svgMap.width - 80);
        $('#line-box').css('left', svgMap.width - 420);
        $('#north').css('left', svgMap.width - 80);
        $('#north').css('top', svgMap.height - 130);
        $('#transfer-box').css('max-height', svgMap.height - 80);
    };
